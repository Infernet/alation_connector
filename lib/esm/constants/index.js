export const ALATION_NEXT_PAGE_HEADER_KEY = 'x-next-page'; // eslint-disable-next-line no-unused-vars

export const ALATION_CATALOG_ROUTE = {
...
export const ALATION_UPDATE_ROUTE = {
...
export function alationCreateRoute(datasourceId) {
  return `api/v1/bulk_metadata/extraction/${datasourceId}?set_title_descs=true`;
}
export function regenerateRefreshTokenRoute(baseUrl) {
  return `${baseUrl}/integration/v1/regenRefreshToken/`;
}
export function createRefreshTokenRoute(baseUrl) {
  return `${baseUrl}/integration/v1/createRefreshToken/`;
}
export function createAccessTokenRoute(baseUrl) {
  return `${baseUrl}/integration/v1/createAPIAccessToken/`;
}
export function validateAccessTokenRoute(baseUrl) {
  return `${baseUrl}/integration/v1/validateAPIAccessToken/`;
}
export function validateRefreshTokenRoute(baseUrl) {
